    ...
    .columns([
      ...
      },
      {
        ...
        format: function(d) {
          return (
            d["fun_fact"] +
            '<div class="py-4"> <button class="btn btn-warning btn-sm my-4"><a style="color:white" target="_blank" href="https://en.wikipedia.org/wiki/' +
            d["breed"] +
